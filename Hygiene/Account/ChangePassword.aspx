<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Hygiene/Hygiene.master" AutoEventWireup="true"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:ChangePassword ID="ChangeUserPassword" runat="server" CancelDestinationPageUrl="~/" 
         ...
         SuccessPageUrl="~/Hygiene/Account/ChangePasswordSuccess.aspx" 
                    ChangePasswordFailureText="کلمه عبور اشتباه می باشد ، دوباره سعی کنید . " 
                    ContinueButtonText="ادامه" Font-Names="Tahoma" style="margin-left: 0px" 
