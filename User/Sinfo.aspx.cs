...
public partial class Sinfo : System.Web.UI.Page
{
    ...
    {
        int idx = Convert.ToInt32(e.CommandArgument);
        if ((e.CommandName == "Delete") && (Roles.IsUserInRole("Finance")))
        {
    ...
    protected void GridView6_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
            Label llb = GridView6.Rows[1].FindControl("label1") as Label;
    ...
    protected void GridView7_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Delete")
        {
            ...
            Label llb1 = GridView6.Rows[1].FindControl("label1") as Label;
