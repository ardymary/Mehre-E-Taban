<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="Sinfo.aspx.cs" Inherits="Sinfo" %>
        ...
        <ContentTemplate><br /><table cellpadding="0" dir="rtl" align="center" border="0" 
                ...
                style="display: block; table-layout: auto; border-collapse: collapse; width: 1024px; margin-left: 0px;"><tr><td align="left" bgcolor="#993333" class="style657" valign="middle"><table align="center" cellspacing="1" class="auto-style49" dir="rtl"><tr><td class="style671" valign="middle">سال تحصیلی:</td><td align="right" class="style672" valign="middle"><asp:DropDownList ID="DropDownList7" runat="server" AppendDataBoundItems="True" 
                    ...
                    bgcolor="#336699" class="style435" 
                        ...
                        dir="rtl"><tr><td align="left" class="style461">طرح تخفیف :</td><td align="right" class="style461"><asp:DropDownList ID="DropDownList12" runat="server" CssClass="style430" 
                                    ...
                                    Width="122px"><asp:ListItem>انتخاب کنید</asp:ListItem><asp:ListItem Value="1">فرهنگی</asp:ListItem><asp:ListItem Value="2">شاهد</asp:ListItem><asp:ListItem Value="3">رافع</asp:ListItem><asp:ListItem Value="4">موسس</asp:ListItem><asp:ListItem>بستانکار</asp:ListItem></asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator51" runat="server" 
                        ...
                        InitialValue="انتخاب کنید" ValidationGroup="t"></asp:RequiredFieldValidator>
                                    ...
                                    MaskType="Number" TargetControlID="txtTakhfif"></asp:MaskedEditExtender></td><td align="right" class="style461">
                        ...
                        <tr><td align="left" class="style461">توضیحات :</td>
                            <td align="right" class="style461" colspan="3">
                                <asp:TextBox ID="TextBox2" runat="server" Width="274px"></asp:TextBox>
                            </td>
                            <td align="right" class="style461">
                                &nbsp;</td>
                </tr><tr><td align="left" class="style379" colspan="5"><span class="style437"><span><table align="center" class="style673" dir="rtl"><tr><td align="center" class="style627"><span class="style437"><span>
                    <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False" 
                        ...
                        OnRowDeleting="GridView7_RowDeleting" Width="347px">
                    ...
                    </span></span></td></tr></table></span></span></td></tr></table></td></tr><tr><td class="style426" align="center"><br /><br /></td></tr><tr><td align="center" class="style426"><asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" 
                ...
                <ControlStyle Font-Size="8pt" ForeColor="#FF3300" />
                    ...
                    <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="TabPanel4">
                        ...
                        <ContentTemplate><br /><table align="center" cellpadding="0" cellspacing="0" class="auto-style1"><tr><td align="center" valign="top"><br /><table align="center" bgcolor="#990033" cellpadding="0" cellspacing="0" class="auto-style22" style="border-collapse: collapse; border-spacing: 0px; "><tr><td class="style646" valign="middle"><span class="style470">سال&nbsp; تحصیلی : </span></td><td class="style626" valign="middle" align="right"><asp:DropDownList ID="DropDownList16" runat="server" AppendDataBoundItems="True" AutoPostBack="True" CssClass="style18" DataSourceID="SqlDataSource8" DataTextField="year" DataValueField="id_years" Height="22px" OnSelectedIndexChanged="DropDownList16_SelectedIndexChanged" Width="119px"><asp:ListItem>انتخاب کنید</asp:ListItem></asp:DropDownList><span class="style17"><asp:RequiredFieldValidator ID="RequiredFieldValidator45" runat="server" 
                                                        ControlToValidate="DropDownList16" ErrorMessage="*" ForeColor="White" 
                                                        InitialValue="انتخاب کنید" ValidationGroup="ff"></asp:RequiredFieldValidator></span></td><td align="center" class="style646" colspan="2" valign="middle">&nbsp;&nbsp; </td><td align="center" class="style355" rowspan="2" valign="middle"><asp:ImageButton ID="ImageButton1" runat="server" AlternateText="پرینت چک و حواله ها" CssClass="style636" Enabled="False" Height="40px" ImageUrl="~/Mehr-Design/print-o-matic_button.png" OnClick="ImageButton1_Click" Width="46px" /></td></tr><tr><td class="style535" valign="middle"><span class="style470">&nbsp;کد ملی دانش آموز :</span>&nbsp;</td><td align="right" class="style624" valign="middle"><asp:TextBox ID="txtcode3" runat="server" CssClass="style16" Enabled="False" Height="20px" Width="126px"></asp:TextBox><asp:MaskedEditExtender ID="txtcode3_MaskedEditExtender" runat="server" 
                                                        AutoComplete="False" Mask="999-999-999-9" MaskType="Number" 
                                                        TargetControlID="txtcode3" CultureAMPMPlaceholder="" 
                                                        CultureCurrencySymbolPlaceholder="" CultureDateFormat="" 
                                                        CultureDatePlaceholder="" CultureDecimalPlaceholder="" 
                                                        CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" 
                                                        InputDirection="RightToLeft" ClearMaskOnLostFocus="False"></asp:MaskedEditExtender><span class="style17"><asp:RequiredFieldValidator ID="RequiredFieldValidator44" runat="server" 
                                ...
                                style="color: #FFCC00; font-weight: 700"></asp:Label></td><td align="center" class="auto-style38" dir="rtl" valign="middle"><strong><font size="2"><asp:Label ID="lblDiscount" runat="server" CssClass="style39" Text="0"></asp:Label></font></strong></td><td align="center" class="auto-style38" dir="rtl" valign="middle"><span class="style39"><font size="2"><strong><asp:Label ID="lblBedehi" runat="server" Text="0"></asp:Label></strong></font></span></td></tr></table><br /><table align="center" cellspacing="1" class="auto-style49" dir="rtl"><tr><td align="center" class="auto-style50" style="background-color: #1277BD; border-bottom-style: ridge; border-color: #CC0000; color: #FFFFFF" valign="bottom">اطلاعات چک</td></tr><tr><td align="center" class="auto-style51" valign="top"><table align="center" class="auto-style3" dir="rtl" style="border-collapse: collapse; border-spacing: 0px" width="1000"><tr><td align="left" bgcolor="#CCCCCC" class="style437">نام بانک :</td><td align="right" bgcolor="#CCCCCC" class="style676"><span class="style17"><asp:TextBox ID="txtNameBankCheck" runat="server" CssClass="style16" Height="22px" Width="110px"></asp:TextBox></span></td><td align="center" bgcolor="#CCCCCC" class="style316"><span class="style17"><asp:RequiredFieldValidator ID="RequiredFieldValidator33" runat="server" ControlToValidate="txtNameBankCheck" ErrorMessage="*" ForeColor="#CC0000" ValidationGroup="check"></asp:RequiredFieldValidator></span></td><td align="center" bgcolor="#CCCCCC" rowspan="9"><span class="style17" dir="rtl"><span class="style17"><asp:GridView ID="GridView4" runat="server" AllowPaging="True" 
                                                                    ...
                                                                    PageSize="5" ShowHeaderWhenEmpty="True" Width="767px"><AlternatingRowStyle BackColor="PaleGoldenrod" /><Columns><asp:BoundField DataField="namebank" HeaderText="نام بانک" 
                                ...
                                <ControlStyle Font-Size="8pt" ForeColor="#FF3300" Width="55px" />
                                                                    ...
                                                                    PageSize="5" ShowHeaderWhenEmpty="True" Width="740px"><AlternatingRowStyle BackColor="PaleGoldenrod" /><Columns><asp:BoundField DataField="accountnumber" HeaderText="شماره فیش" 
