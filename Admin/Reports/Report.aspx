<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Report.aspx.cs" Inherits="Admin_Reports_Report" %>
            ...
            <td align="center" dir="rtl" valign="middle">
                <telerik:RadTabStrip ID="RadTabStrip1" runat="server" Align="Center" 
                    ...
                    <Tabs>
                        ...
                        <telerik:RadTab runat="server" Text="گزارش خدمات" PageViewID="ReportViewer10">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" Text="گزارش بدهی خالص" 
                            PageViewID="ReportViewer11">
                        </telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
