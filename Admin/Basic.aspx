<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Basic.aspx.cs" Inherits="User_Basic" %>
                ...
                <td align="center" colspan="4" class="style392">
                    ...
                    <td align="center" class="style392" colspan="2">
                        <asp:Button ID="Button1" runat="server" Font-Names="Tahoma" 
                            PostBackUrl="~/Admin/Searchteacher.aspx" Text="جستجوی آموزگار" 
                            Width="126px" />
                    </td>
                    <td align="center" class="style392" colspan="2">
