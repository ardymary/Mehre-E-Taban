<%@ Page Title="" Language="C#" MasterPageFile="~/Finance/Finance.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Admin_Search" %>
        ...
        MultiPageID="RadMultiPage1" Skin="WebBlue" SelectedIndex="0">
            <Tabs>
                <telerik:RadTab runat="server" ScrollButtonsPosition="Middle" 
                    Text="جستجوی پیشرفته" Font-Names="tahoma" Font-Size="10pt" Selected="True">
                </telerik:RadTab>
                <telerik:RadTab runat="server" ScrollButtonsPosition="Middle" 
