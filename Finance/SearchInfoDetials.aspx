<%@ Page Title="" Language="C#" MasterPageFile="~/Finance/Finance.master" AutoEventWireup="true" CodeFile="SearchInfoDetials.aspx.cs" Inherits="User_SearchInfo" %>
                                ...
                                <tr>
                                    ...
                                    <td class="style690">
                                        ...
                                        <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="White" 
                                            OnClick="LinkButton1_Click" PostBackUrl="~/Finance/Sinfo.aspx">ثبت چک و حواله</asp:LinkButton>
                                        </span></span>
                                    </td>
                                    <td>
                                        &nbsp;</td>
