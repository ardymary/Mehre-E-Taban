<%@ Page Title="" Language="C#" MasterPageFile="~/Finance/Finance.master" AutoEventWireup="true" CodeFile="Basic.aspx.cs" Inherits="User_Basic" %>
                ...
                <td align="center" colspan="4" class="style392">
                    ...
                    <td align="center" class="style392" colspan="2">
                        <asp:Button ID="Button1" runat="server" Font-Names="Tahoma" Text="جستجوی آموزگار" 
                            Width="126px" PostBackUrl="~/Finance/Searchteacher.aspx" />
                    </td>
                    <td align="center" class="style392" colspan="2">
